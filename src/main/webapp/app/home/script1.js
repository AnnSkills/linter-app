desktopApp1 = angular.module('desktopApp', []);

desktopApp1.run(function () {
...
desktopApp1.service('youtubePlayerApi', ['$window', '$rootScope', '$log',
  function ($window, $rootScope, $log) {
    let service = $rootScope.$new(true);
...
desktopApp1.controller('PlayerController', ['$scope', 'youtubePlayerApi',
